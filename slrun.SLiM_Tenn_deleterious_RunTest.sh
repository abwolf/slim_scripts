...
#SBATCH --time 5-0
#SBATCH --qos=1wk
#SBATCH --output=slrun.SLiM_Tenn_deleterious_RunTest.sh.%A_%a.o
source ~/.bashrc
...
model2=$(echo Tennessen_model_DeleteriousMutation.slim)
##########
...
time slim \
	...
	-d d_sampleP2=$sample_P2 \
	-d d_sampleP3=$sample_P3 \
	-d "d_outfileP2='"$fileP2.mdl2"'" \
	-d "d_outfileP3='"$fileP3.mdl2"'" \
	$PROJ/bin/$model2
